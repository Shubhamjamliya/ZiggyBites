  ...
  return (
    <header className="sticky top-0 z-50 bg-[#fff9f2]/95 dark:bg-[#121212]/95 backdrop-blur-md px-5 pt-3 pb-2 border-b border-transparent dark:border-gray-800/80 transition-colors duration-200">
      <div className="relative flex min-h-[34px] items-center justify-between gap-3">
        ...
        >
          <MapPin className="h-4 w-4 text-black dark:text-white fill-black dark:fill-white shrink-0" />
          ...
          <ChevronDown className="h-3.5 w-3.5 text-gray-700 dark:text-gray-400 shrink-0" />
        </button>

        <div className="pointer-events-none absolute left-1/2 top-1/2 w-[34%] -translate-x-1/2 -translate-y-1/2 text-center">
          <div className="text-[18px] leading-none font-black italic text-[#e92823] dark:text-[#ff5257] tracking-tight">
            ZiggyBites
          </div>
          <div className="truncate text-[5px] font-black text-gray-700 dark:text-gray-400 tracking-[0.08em]">
      ...
      <div className="mt-4 flex items-center gap-2">
        <button
          ...
          className="h-10 flex-1 bg-white dark:bg-[#1e1e1e] rounded-full border border-orange-100 dark:border-gray-700/70 shadow-sm px-4 flex items-center gap-2 text-left transition-colors"
        >
          <Search className="h-4 w-4 text-[#e92823] dark:text-[#ff5257]" />
        ...
        >
          ...
          <span
            className={`absolute -bottom-1 right-0 h-3.5 w-7 rounded-full border border-white dark:border-gray-900 bg-[#9bd46f] transition-colors ${
              vegMode ? "bg-[#6aad37]" : "bg-gray-300 dark:bg-gray-600"
            }`}
          >
            <span
